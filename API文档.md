...
```json
{
  "amount": 125.50,          // 金额，必填，精确到小数点后2位，支持小数点
  "type": 2,                 // 交易类型，必填，1-收入，2-支出，默认为2(支出)
  "categoryId": 8,           // 分类ID，必填，从预设类目中选择
  "paymentMethod": "微信支付", // 支付方式，非必填，有默认值，可选择微信支付、支付宝、银行卡、现金
  "transactionTime": "2023-06-20T12:30:00", // 交易时间，有默认值(当前日期)，可选择过去日期
  "description": "超市购物"   // 交易描述/备注，非必填，短文本描述
}
```
